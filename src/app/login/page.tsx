        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <svg width="40" height="40" viewBox="0 0 127.14 96.36" fill="#f3f4f6">
                ...
                <h1 style={{ fontSize: "1.5rem", fontWeight: "600", margin: "0 0 8px 0", letterSpacing: "-0.02em" }}>Welcome Back</h1>
                <p style={{ color: "#a1a1aa", fontSize: "0.95rem", margin: "0 0 32px 0" }}>
